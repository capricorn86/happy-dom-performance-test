...
function serializeHTML() {
    ...
    const time2 = performance.now();
    console.log(`HappyDOM -> Serialize HTML: ${time2 - time1}ms`);
}
...
function querySelectorAllLiElements() {
    ...
    const time2 = performance.now();
    console.log(`HappyDOM -> querySelectorAll('li') found ${elements.length} elements: ${time2 - time1}ms`);
}
...
function querySelectorAllClassElements() {
    ...
    const time2 = performance.now();
    console.log(`HappyDOM -> querySelectorAll('.flex-shrink-0') found ${elements.length} elements: ${time2 - time1}ms`);
}
...
function querySelectorAllAttributeElements() {
    ...
    const time2 = performance.now();
    console.log(`HappyDOM -> querySelectorAll('[aria-label]') found ${elements.length} elements: ${time2 - time1}ms`);
}
...
function querySelectorAllAttributeContainsElements() {
    ...
    window.document.write(HTMLPage);
    const time1 = performance.now();
    const elements = window.document.querySelectorAll('[class~="flex-shrink-0"]');
    const time2 = performance.now();
    console.log(`HappyDOM -> querySelectorAll('[class~="flex-shrink-0"]') found ${elements.length} elements: ${time2 - time1}ms`);
}
...
function querySelectorAllNthChildElements() {
    ...
    const time2 = performance.now();
    console.log(`HappyDOM -> querySelectorAll(':nth-child(2n+1)') found ${elements.length} elements: ${time2 - time1}ms`);
}
